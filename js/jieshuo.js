$(function () {
    ...
    //歌曲列表1
    var musics = [
        {path:'mp3/带我飞.mp3',name:'带我飞',artistan:'林志玲',duration:'04:12',src:'img/music/lzl.png',lyrics:[
            {time:"0:01",lyric:"《大唐无双2》主题曲"},
            {time:"0:02",lyric:"林志玲 - 带我飞"},
            {time:"0:03",lyric:"作词:林志玲 "},
            {time:"0:04",lyric:"作曲:周杰伦"},
            {time:"0:04",lyric:"lewis 制作"},
            {time:"0:05",lyric:"你还记得我吗"},
            {time:"0:08",lyric:"从来不曾忘记"},
            {time:"0:12",lyric:"www.5ilrc.com"},
            {time:"0:28",lyric:"你说我像个孩子爱耍赖"},
            {time:"0:34",lyric:"风无需 趁着因为雨不在"},
            {time:"0:39",lyric:"雨梦飞 漂落在层层骚浪中"},
            {time:"0:47",lyric:"思念傻傻的水中游"},
            {time:"0:51",lyric:" "},
            {time:"0:52",lyric:"剪不断 彷佛坠落万尘空"},
            {time:"0:58",lyric:"理还乱 浮云但添愁外愁"},
            {time:"1:03",lyric:"难将息 躲於乍暖还寒之际"},
            {time:"1:10",lyric:"带我飞 因为你我们可以"},
            {time:"1:16",lyric:" "},
            {time:"1:18",lyric:"寻寻觅觅 浮浮沉沉"},
            {time:"1:25",lyric:"无边无际 应不应该"},
            {time:"1:30",lyric:"一字一语 爱是千种姿态"},
            {time:"1:37",lyric:"无罣无碍 到现在才明白"},
            {time:"1:42",lyric:" "},
            {time:"2:00",lyric:"你 还在寻找我吗"},
            {time:"2:05",lyric:"从开始 到现在"},
            {time:"2:09",lyric:" "},
            {time:"2:11",lyric:"你说我 像个孩子爱耍赖"},
            {time:"2:17",lyric:"风无须 逞强因为雨不在"},
            {time:"2:23",lyric:"羽毛飞 飘舞在静止沙漏中"},
            {time:"2:30",lyric:"思念 傻傻地 水中游"},
            {time:"2:34",lyric:" "},
            {time:"2:35",lyric:"剪不断 彷佛坠落万尘空"},
            {time:"2:42",lyric:"理还乱 浮云但添愁外愁"},
            {time:"2:48",lyric:"难将息 躲於乍暖还寒之际"},
            {time:"2:54",lyric:"带我飞 因为你我们可以"},
            {time:"3:01",lyric:" "},
            {time:"3:03",lyric:"寻寻觅觅 浮浮沉沉"},
            {time:"3:09",lyric:"无边无际 应不应该"},
            {time:"3:16",lyric:"一字一语 爱是千种姿态"},
            {time:"3:22",lyric:"无罣无碍 到现在才明白"},
            {time:"3:27",lyric:"寻寻觅觅 浮浮沉沉"},
            {time:"3:33",lyric:"无边无际 应不应该"},
            {time:"3:40",lyric:"一字一语 爱是千种姿态"},
            {time:"3:46",lyric:"无罣无碍 到现在才明白"},
            {time:"3:53",lyric:" "},
            {time:"4:02",lyric:"何不就这样 把我留在心里"},
            {time:"4:08",lyric:"所以 我才不会放弃"}]
        },
